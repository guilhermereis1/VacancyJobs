...
class VacanciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacancy" do
    assert_difference('Vacancy.count') do
      post vacancies_url, params: { vacancy: { category_id: @vacancy.category_id, content: @vacancy.content, name: @vacancy.name, salary: @vacancy.salary } }
    end
  ...
  test "should update vacancy" do
    patch vacancy_url(@vacancy), params: { vacancy: { category_id: @vacancy.category_id, content: @vacancy.content, name: @vacancy.name, salary: @vacancy.salary } }
